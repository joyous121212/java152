...
public class AppMain07 implements Notifiable {
	...
	private void initialize() {
		frame = new JFrame();
		frame.setBounds(100, 100, 448, 531);
...
//				JOptionPane.showMessageDialog(frame, "안녕하세요");
		...
		btnMsgDlg.setBounds(12, 10, 408, 58);
...
//				int result = JOptionPane.showConfirmDialog(frame, "정말 삭제할까요?");
		...
		btnConfirmDlg.setBounds(12, 78, 408, 58);
		...
		btnInputDlg.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				// 입력 다이얼로그 보여주기
//				Object result = JOptionPane.showInputDialog(frame, "검색어");
		...
		btnInputDlg.setBounds(12, 146, 408, 58);
		...
		btnCustomDlg.setBounds(12, 214, 408, 58);
		...
		btnMyFrame.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				//-> 아규먼트 AppMain07.this: AppMaina07 타입으로 생성된 객체(의 주소). 현재 객체.
				//   MyFrame 클래스에서 AppMain07 객체의 public 메서드를 호출할 수 있도록. 
			}
		});
		btnMyFrame.setFont(new Font("D2Coding", Font.PLAIN, 24));
		btnMyFrame.setBounds(12, 282, 408, 58);
