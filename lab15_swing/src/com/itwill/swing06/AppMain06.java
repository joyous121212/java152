...
public class AppMain06 {
	...
	private void initialize() {
		frame = new JFrame();
		frame.setBounds(100, 100, 649, 513);
		...
		rbPrivate.setFont(new Font("D2Coding", Font.PLAIN, 26));
		rbPrivate.setBounds(8, 6, 147, 55);
		...
		rbPackage.setFont(new Font("D2Coding", Font.PLAIN, 26));
		rbPackage.setBounds(159, 6, 147, 55);
		...
		rbProtected.setFont(new Font("D2Coding", Font.PLAIN, 26));
		rbProtected.setBounds(310, 6, 147, 55);
		...
		rbPublic.setFont(new Font("D2Coding", Font.PLAIN, 26));
		rbPublic.setBounds(461, 6, 147, 55);
		...
		cbAbstract.setFont(new Font("D2Coding", Font.PLAIN, 26));
		cbAbstract.setBounds(8, 76, 147, 55);
		frame.getContentPane().add(cbAbstract);
		
		cbFinal = new JCheckBox("final");
		cbFinal.addActionListener((e) -> handleCheckBoxClick(e));
		cbFinal.setFont(new Font("D2Coding", Font.PLAIN, 26));
		cbFinal.setBounds(159, 76, 147, 55);
		frame.getContentPane().add(cbFinal);
		
		cbStatic = new JCheckBox("static");
		cbStatic.addActionListener(this::handleCheckBoxClick);
		cbStatic.setFont(new Font("D2Coding", Font.PLAIN, 26));
		cbStatic.setBounds(310, 76, 147, 55);
