...
public class AppMain03 {
	...
	private void initialize() {
		...
		lblImage.setBounds(90, 30, 400, 400);
		...
		btnPrev.setBounds(100, 440, 97, 82);
		...
		btnNext.setBounds(393, 440, 97, 79);
		frame.getContentPane().add(btnNext);
		
		lblImageName = new JLabel(IMAGES[curIndex]);
		lblImageName.setHorizontalAlignment(SwingConstants.CENTER);
		lblImageName.setFont(new Font("굴림", Font.PLAIN, 19));
		lblImageName.setBounds(209, 440, 172, 82);
	...
	private void showPrevImage() {
		...
		// JLable의 이미지를 아이콘을 이전 이미지 아이콘으로 변경
		lblImage.setIcon(new ImageIcon(IMAGES[curIndex]));
