...
-- 연봉 내림차순 정렬.
select ename, sal, nvl(comm, 0), sal * 12 + nvl(comm, 0) as ANNUAL_SAL
from emp
...
-- Ex. 매니저가 KING인 직원들의 사번, 이름, 매니저 사번을 검색.  mgr = king의 사번
...
-- Ex. ACCOUNTING 부서에 일하는 직원들의 이름, 급여, 부서번호를 검색. accounting 부서 dept 테이블에 있음.
